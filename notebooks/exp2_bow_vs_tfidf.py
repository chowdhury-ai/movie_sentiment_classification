...
CONFIG = {
    ...
    "dagshub_repo_owner": "Provide Repo Owner Name here",
    "dagshub_repo_name": "Provide Repo Name Here",
            ...
            for vec_name, vectorizer in VECTORIZERS.items():
                try:
                    with mlflow.start_run(run_name=f"{algo_name} with {vec_name}", nested=True) as child_run:
                        ...
                        x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=CONFIG['test_size'], random_state=7)
